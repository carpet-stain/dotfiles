...
pacstrap /mnt base linux linux-firmware base-devel zsh efibootmgr man-db man-pages intel-ucode nftables iw iwd git cmake jq sddm firefox plasma-desktop plasma-wayland-session bluez bluez-utils dolphin firefox kate konsole plasma-nm plasma-pa

...
# Shared vended-token bridge (infra#195, see AGENTS.md's Credentials
# section). Caller must source .envrc.local before calling this.
use_github_token() {
  ...
  # Resolution order (#453, AGENTS.md Credentials): .envrc.local wins,
